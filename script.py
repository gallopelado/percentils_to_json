...
def join_all():
    ...
    peso_m_23 = convert_to_json("./txt/tab_wfa_boys_p_0_5.txt")

    peso_f_23 = convert_to_json("./txt/tab_wfa_girls_p_0_5.txt")
    ...
    imc_m_23 = convert_to_json("./txt/tab_bmi_boys_p_0_2.txt")
    imc_m_23.pop()
    imc_m_24 = convert_to_json("./txt/tab_bmi_boys_p_2_5.txt")

    imc_f_23 = convert_to_json("./txt/tab_bmi_girls_p_0_2.txt")
    imc_f_23.pop()
    imc_f_24 = convert_to_json("./txt/tab_bmi_girls_p_2_5.txt")
